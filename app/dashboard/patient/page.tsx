  ...
  return (
    <div className="space-y-lg relative">
      ...
      <div>
        ...
        <p className="text-on-surface-variant dark:text-slate-400 text-sm">You have 1 appointment today and your health vitals look stable.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        ...
        <div className="col-span-12 lg:col-span-8 glass-card rounded-3xl p-6 md:p-8 flex flex-col justify-between h-80 relative overflow-hidden border-white/20 dark:border-white/10 shadow-lg">
          ...
          <div className="flex justify-between items-start z-10">
            <div>
              ...
              <p className="text-xs text-on-surface-variant/60 dark:text-slate-400">Last updated: 5 mins ago via MediWatch</p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8 z-10">
            <div className="bg-white/40 dark:bg-slate-900/40 p-4 rounded-2xl border border-white/50 dark:border-white/10 shadow-sm">
              <p className="text-xs text-on-surface-variant/80 dark:text-slate-300 font-bold mb-1">Heart Rate</p>
              <div className="flex items-baseline gap-1">
                <span className="font-headline-lg text-headline-lg font-bold text-primary dark:text-inverse-primary">72</span>
                <span className="text-xs text-on-surface-variant/60 dark:text-slate-400 font-semibold">BPM</span>
              </div>
            ...
            <div className="bg-white/40 dark:bg-slate-900/40 p-4 rounded-2xl border border-white/50 dark:border-white/10 shadow-sm">
              <p className="text-xs text-on-surface-variant/80 dark:text-slate-300 font-bold mb-1">Blood Pressure</p>
              <div className="flex items-baseline gap-1">
                <span className="font-headline-lg text-headline-lg font-bold text-secondary">118/76</span>
                <span className="text-xs text-on-surface-variant/60 dark:text-slate-400 font-semibold">mmHg</span>
              </div>
              <div className="mt-4 h-1 w-full bg-outline-variant/20 rounded-full overflow-hidden">
            ...
            <div className="bg-white/40 dark:bg-slate-900/40 p-4 rounded-2xl border border-white/50 dark:border-white/10 shadow-sm">
              <p className="text-xs text-on-surface-variant/80 dark:text-slate-300 font-bold mb-1">SPO2</p>
              <div className="flex items-baseline gap-1">
                <span className="font-headline-lg text-headline-lg font-bold text-on-surface dark:text-white">98</span>
                <span className="text-xs text-on-surface-variant/60 dark:text-slate-400 font-semibold">%</span>
              </div>
              <div className="mt-4 h-1 w-full bg-outline-variant/20 rounded-full overflow-hidden">
        ...
        <div className="col-span-12 lg:col-span-4 glass-card rounded-3xl p-6 flex flex-col h-80 border-white/20 dark:border-white/10 shadow-lg">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface-variant/80 dark:text-slate-300">Upcoming Visits</h3>
          ...
          <div className="flex-1 space-y-3 overflow-y-auto pr-1">
            <div className="flex gap-3.5 p-3 bg-primary-container/5 rounded-2xl border border-primary/10">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant/80 dark:text-slate-400 mt-0.5">09:30 AM • Dr. Sarah Chen</p>
              </div>
            </div>
            <div className="flex gap-3.5 p-3 hover:bg-surface-container-high/20 rounded-2xl transition-colors border border-transparent">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant/80 dark:text-slate-400 mt-0.5">02:15 PM • Dr. James Miller</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-5 glass-card rounded-3xl p-6 h-[380px] flex flex-col border-white/20 dark:border-white/10 shadow-lg">
          <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface-variant/80 dark:text-slate-300 mb-4">Recent Activity</h3>
            ...
            {activities.map((act) => (
              <div key={act.id} className="flex gap-3 items-start">
                ...
                <div className="flex-1 border-b border-outline-variant/10 pb-3">
                  ...
                  <p className="text-xs text-on-surface-variant dark:text-slate-300 mt-0.5 leading-relaxed">{act.desc}</p>
                  <p className="text-[10px] text-on-surface-variant/60 dark:text-slate-400 font-semibold mt-1">{act.time}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="col-span-12 md:col-span-6 lg:col-span-4 glass-card rounded-3xl p-6 h-[380px] border-white/20 dark:border-white/10 shadow-lg flex flex-col">
          <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface-variant/80 dark:text-slate-300 mb-4">Favorite Doctors</h3>
          <div className="grid grid-cols-2 gap-3 flex-1">
            <div className="bg-white/30 dark:bg-slate-900/30 rounded-2xl p-3.5 text-center border border-white/20 dark:border-white/5 hover:border-primary/30 transition-all cursor-pointer flex flex-col justify-center">
              ...
              <p className="text-[10px] text-on-surface-variant/60 dark:text-slate-400 font-semibold truncate mt-0.5">Cardiology</p>
            </div>
            <div className="bg-white/30 dark:bg-slate-900/30 rounded-2xl p-3.5 text-center border border-white/20 dark:border-white/5 hover:border-primary/30 transition-all cursor-pointer flex flex-col justify-center">
              ...
              <p className="text-[10px] text-on-surface-variant/60 dark:text-slate-400 font-semibold truncate mt-0.5">Pediatrics</p>
            </div>
            <div className="bg-white/30 dark:bg-slate-900/30 rounded-2xl p-3.5 text-center border border-white/20 dark:border-white/5 hover:border-primary/30 transition-all cursor-pointer flex flex-col justify-center">
              ...
              <p className="text-[10px] text-on-surface-variant/60 dark:text-slate-400 font-semibold truncate mt-0.5">Orthopedic</p>
            </div>
        ...
        <div className="col-span-12 md:col-span-6 lg:col-span-3 glass-card rounded-3xl p-6 h-[380px] flex flex-col justify-between overflow-hidden border-white/20 dark:border-white/10 shadow-lg relative">
          <div className="z-10">
            <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface-variant/80 dark:text-slate-300 mb-6">Billing Summary</h3>
            <div className="mb-4">
              <p className="text-xs text-on-surface-variant/60 dark:text-slate-400">Total Paid (2026)</p>
              <h4 className="text-xl font-bold text-primary dark:text-inverse-primary">${totalPaid.toFixed(2)}</h4>
            </div>
            <div className="mb-4">
              <p className="text-xs text-on-surface-variant/60 dark:text-slate-400">Outstanding Balance</p>
          ...
          <button 
            ...
            className={`w-full py-2.5 rounded-xl text-xs font-bold transition-all z-10 cursor-pointer shadow-md ${
              balance > 0 
                ...
                : 'bg-surface-container-low dark:bg-slate-800 text-on-surface-variant/50 dark:text-slate-500 cursor-not-allowed'
            }`}
            disabled={balance === 0}
          >
      ...
      {showToast && (
        <div className="fixed bottom-6 right-6 glass-card rounded-2xl p-4 shadow-2xl z-[100] flex items-center gap-3 max-w-sm border-white/20 dark:border-white/10 animate-slide-in">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-on-surface-variant dark:text-slate-300">Your watch telemetry vitals were successfully synced.</p>
          </div>
          <button className="text-on-surface-variant/60 dark:text-slate-400 hover:text-on-surface dark:hover:text-white p-1 cursor-pointer" onClick={() => setShowToast(false)}>
